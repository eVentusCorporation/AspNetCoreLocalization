...
public class LocalizationModelContext : DbContext
{
    ...
    public LocalizationModelContext(DbContextOptions<LocalizationModelContext> options,
        IOptions<SqlContextOptions> contextOptions) : base(options)
    {
    ...
    private void UpdateUpdatedProperty<T>() where T : class
    {
        ...
        foreach (var entry in modifiedSourceInfo) entry.Property("UpdatedTimestamp").CurrentValue = DateTime.UtcNow;
    }
